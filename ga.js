...
Tracker.prototype.setDocumentPath = function (screenName) {
  return this.set("dl", screenName);
}
...
Tracker.prototype.send_queue_push = function (ga, hit) {
  ...
  var data = {
    ...
    sd: "24-bit",
    je: 0,
    //dl: t.hit.dl,//screenName
    sr: ga.sr,
    vp: ga.vp,
    ua: ga.userAgent
    uid: getApp().globalData.userId,
    cd1: "Security Key",
    cd2: ga.systemInfo.language,
    cd3: "Country of Mini Program",
    cd4: "Brand",
    cd5: "Mini Program Category Audience",
    cd8: new Date().getHours(),
    cd9: new Date().getMinutes(),
    cd10: new Date().getDate(),
    cd11: getDayOfWeek(),
    cd12: new Date().getSeconds(),
    cd13: getTimeZone(),
    cd14: ga.systemInfo.language,
    cd15: "Environment",
    cd16: "Mini Program",
    cd19: ga.cid,
    cd20: ga.userAgent,
